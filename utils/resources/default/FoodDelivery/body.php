    ...
    <form action="" method="post">
        ...
        <div class="form-row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control" name="apellidos" value="" required>
            </div>
            <div class="col-md-4 mb-3">
                <label>Numero de teléfono movil</label>*
                <input type="tel" class="form-control" name="telefonoMovil" value="" placeholder="xx-xx-xx-xx-xx" pattern="[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}" required>
            </div>
        </div>
        <div class="form-row">
        ...
        <button id="varGuardador" class="btn btn-success" href="#" name="guardar" onclick="validarGuardar(event)" disabled>Guardar</button>
